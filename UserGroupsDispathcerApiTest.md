...
```
Request method:	GET
Request URI:	http://localhost:58970/userGroups?groupName=dispatcher
Proxy:			<none>
Request params:	<none>
Query params:	<none>
Form params:	<none>
...

{
    ...
    "_links": {
        "self": {
            "href": "http://localhost:58970/v1/userGroups/2"
        },
        "userGroup": {
            "href": "http://localhost:58970/v1/userGroups/2"
        },
        "relations": {
            "href": "http://localhost:58970/v1/userGroups/2/relations"
        }
    }
}
...
```
Request method:	POST
Request URI:	http://localhost:58970/userGroups/2/defaultAors
Proxy:			<none>
Request params:	<none>
Query params:	<none>
Form params:	<none>
...
HTTP/1.1 200 
Content-Length: 0
Date: Tue, 16 Oct 2018 08:47:56 GMT
get defaultAors
------------------------------------------------------------------------
...

{
        ...
        "modelAors": [
            {
                ...
                "_links": {
                    "self": {
                        "href": "http://localhost:58970/v1/modelAors/24"
                    },
                    "aor": {
                        "href": "http://localhost:58970/v1/modelAors/24"
                    },
                    "sessions": {
                        "href": "http://localhost:58970/v1/modelAors/24/sessions"
                    }
                }
            },
            {
                ...
                "_links": {
                    "self": {
                        "href": "http://localhost:58970/v1/modelAors/2"
                    },
                    "aor": {
                        "href": "http://localhost:58970/v1/modelAors/2"
                    },
                    "sessions": {
                        "href": "http://localhost:58970/v1/modelAors/2/sessions"
                    }
                }
            },
            {
                ...
                "_links": {
                    "self": {
                        "href": "http://localhost:58970/v1/modelAors/1"
                    },
                    "aor": {
                        "href": "http://localhost:58970/v1/modelAors/1"
                    },
                    "sessions": {
                        "href": "http://localhost:58970/v1/modelAors/1/sessions"
                    }
                }
            }
        ]
    ...
    "_links": {
        "self": {
            "href": "http://localhost:58970/userGroups/2/defaultAors?onlyLowestAors=false"
        }
    }
}
```
